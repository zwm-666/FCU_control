...
export const SchematicView: React.FC<Props> = ({ data }) => {
  ...
  return (
    <div className="relative w-full h-[380px] bg-slate-900 rounded-xl border border-slate-700 overflow-hidden shadow-inner flex items-center justify-center select-none">
      ...
      <div className="flex items-center justify-center relative z-10 w-full max-w-6xl px-4">
        ...
        <div className="flex flex-col gap-10">
            ...
            <div className="flex items-center">
                ...
                <div className="relative z-10 flex flex-col items-center">
                    <div className={`w-10 h-10 rounded border-2 flex items-center justify-center bg-slate-800 transition-colors z-10 ${data.io.h2InletValve ? 'border-green-400 shadow-lg shadow-green-500/20' : 'border-slate-600'}`}>
                        <div className={`w-1 h-5 bg-current transition-transform duration-300 ${data.io.h2InletValve ? 'rotate-90 text-green-400' : 'text-slate-500'}`}></div>
                    </div>
        ...
        <div className="relative mx-[-2px] flex flex-col items-center">
            ...
            <div className="absolute top-full flex flex-col items-center z-20 -mt-0.5">
                 ...
                 {/* Valve Icon */}
                 <div className={`w-8 h-6 rounded border bg-slate-800 flex items-center justify-center z-10 ${data.io.h2PurgeValve ? 'border-green-400' : 'border-slate-600'}`}>
                     <Droplets className={`w-3.5 h-3.5 ${data.io.h2PurgeValve ? 'text-green-400' : 'text-slate-500'}`} />
                 </div>
                 {/* Label */}
      ...
      {/* Connection Legend */}
      <div className="absolute bottom-2 right-4 flex gap-4 text-[9px] text-slate-600 font-medium z-30">
         <div className="flex items-center gap-1"><div className="w-3 h-1 bg-cyan-900"></div> 氢气</div>
         <div className="flex items-center gap-1"><div className="w-3 h-1 bg-sky-900"></div> 空气</div>
         <div className="flex items-center gap-1"><div className="w-3 h-1 bg-amber-900"></div> 电力</div>
      </div>
