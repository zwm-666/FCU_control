    ...
    return (
        <div className="min-h-screen bg-slate-900 text-slate-200 font-sans selection:bg-cyan-500/30 flex flex-col">
            ...
            <header className="bg-slate-950 border-b border-slate-800 px-6 py-3 flex justify-between items-center shadow-md z-10 sticky top-0">
                <div className="flex items-center gap-4">
                    ...
                    <div className="hidden md:block">
                        ...
                        <p className="text-[10px] text-slate-500 font-mono">FCU-2025-X01 • {connectionConfig.interfaceType.toUpperCase()}</p>
                    </div>
                </div>
            ...
            <div className="bg-slate-950 border-t border-slate-800 py-1 px-4 text-center text-[10px] text-slate-600 font-mono">
                CAN Rx: 0x18FF01F0, 0x18FF02F0, 0x18FF03F0, 0x18FF04F0 | Tx: 0x18FF10A0 | Config: {connectionConfig.interfaceType} @ {connectionConfig.bitrate} bps
            </div>
