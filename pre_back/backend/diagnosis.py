...
class OnlineDiagnosis:
    ...
    def __init__(self, model_dir: str = "models", enable_model_prediction: bool = True):
        self.model_dir = model_dir
        self.enable_model_prediction = enable_model_prediction
    ...
    def _initialize(self):
        ...
        if not self.enable_model_prediction:
            logger.info("模型预测已禁用，诊断仅使用规则模式")
            return
    ...
    def predict(self, machine_state: Dict) -> Dict:
        ...
        if not self.enable_model_prediction or not TF_AVAILABLE or self.model is None:
            # 回退到规则诊断
    ...
    def get_status(self) -> Dict:
        ...
        return {
            ...
            "model_prediction_enabled": self.enable_model_prediction,
            "is_trained": self.is_trained,
            "sample_count": self.sample_count,
